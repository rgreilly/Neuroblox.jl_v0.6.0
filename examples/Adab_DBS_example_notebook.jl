...
# ╔═╡ 1d4c6b44-1928-11ef-2985-ff4ed2472f90
using Neuroblox

# ╔═╡ ffedfb4d-44fe-43ca-9c5f-0ae41b724c20
using DifferentialEquations

# ╔═╡ 74a59599-e42b-4a19-8b59-529e8b3d8bb8
using Graphs

# ╔═╡ 0c2b0150-5d2b-48a1-9487-634bde3ff563
using MetaGraphs

# ╔═╡ 607a2e26-2095-43ae-a221-f3d5e95f8401
using Plots

# ╔═╡ 9ca48018-bc7f-4110-b3aa-800b7dea409f
begin
global_ns = :g
...
# ╔═╡ 2a27de07-7928-439a-9bc8-bffc1fd760c4
@named neuron_net = system_from_graph(g)

# ╔═╡ 89568f43-b260-4a98-8128-2d2313115d47
sys = structural_simplify(neuron_net)

# ╔═╡ d56cd79b-5ced-4aa3-bbb9-5a337e40bb8b
prob = SDEProblem(sys, [], (0.0, 500), [])

# ╔═╡ d25da273-b090-4ec8-bc58-f133eef00b68
sol = solve(prob, saveat = 0.01)

# ╔═╡ 10f22f39-acda-4ca3-aa4a-7dc8e10c2884
ss=convert(Array,sol)

# ╔═╡ 43cdb545-4bc0-4b79-a671-3f9bb53c6b75
...
manifest_format = "2.0"
project_hash = "c7fbbb971bd47406db4ed7b3feb2b27f9a07b542"
...
git-tree-sha1 = "3cb31e755ed670898ee0333d77b9096b5a45fb49"
